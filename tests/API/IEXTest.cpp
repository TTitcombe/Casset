...
public:
    ...
    // uncomment the following line and the tests will work
    //MAKE_MOCK1(isValidSymbol, bool(const std::string));
};
...
TEST_CASE( "Test IEX isValidSymbol", "[API]") {
  ...
  // uncomment the following ALLOW_CALL and the tests will work
  /*
  ALLOW_CALL(iex_mock, isValidSymbol(_))
    .RETURN(true);
   */
